...
subroutine QPT_problem_c_init(self, main, m, n, A_ne, H_ne, eqp_bool)
...
integer, value :: m, n
integer, value :: A_ne				! # of elements in A (constraint) matrix
integer, value :: H_ne				! # of elements in H (Hessian) matrix
integer, value :: eqp_bool		! Are we preparing for a problem w/ equality constraints? (1=true, 0=false)
...
subroutine QPT_problem_delete_c(main_c)
use GALAHAD_QPT_double
USE qpt_x
use, intrinsic :: iso_c_binding
IMPLICIT NONE
