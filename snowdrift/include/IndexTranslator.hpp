...
public:
	...
	public void init(int size_a, std::set<int> const &used);

	int na() { return _a2b.size(); }
	int nb() { return _b2a.size(); }

	int a2b(int a, bool check_result = true);
	int b2a(int b, bool check_result = true);
};



inline int IndexTranslator::a2b(int a, bool check_result) {
	if (a < 0 || a >= _a2b.size()) {
...
inline int IndexTranslator::b2a(int b, bool check_result) {
	if (b < 0 || b >= _b2a.size()) {
